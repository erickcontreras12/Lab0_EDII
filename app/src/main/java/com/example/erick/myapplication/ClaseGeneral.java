...
public class ClaseGeneral{
    ...
    public static List<Cancion> playlist = new List<Cancion>() {
        @Override
        public int size() {
            return 0;
        }
        ...
        @Override
        public boolean addAll(@NonNull Collection<? extends Cancion> c) {
            return false;
        }

        @Override
        public boolean addAll(int index, @NonNull Collection<? extends Cancion> c) {
            return false;
        }
        ...
        @Override
        public Cancion set(int index, Cancion element) {
            return null;
        }

        @Override
        public void add(int index, Cancion element) {
        ...
        @NonNull
        @Override
        public ListIterator<Cancion> listIterator(int index) {
            return null;
        }

        @NonNull
        @Override
        public List<Cancion> subList(int fromIndex, int toIndex) {
            return null;
        }
    };
